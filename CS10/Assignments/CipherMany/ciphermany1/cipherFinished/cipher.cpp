...
int main()
{
    ...
    {
        cout << endl << "Error: invalid method choice." << endl;
        return 0;
    }
    //here is a comment. are you happy now?
    cout << endl << "What is the translation map ";
    ...
    if(modusOperendi == "encryption")
    {
        ...
        cout << endl << "Encrypted word: "<< userWord << endl;
        return 0;
    }
    else
    {
        for(int i = 0; i < userWord.length(); i++)
        {
            letterPosition = positionInString(userWord.at(i), translationMap);
            letterPosition += 97;
