...
double truncateSix(double toTruncate)
{
    toTruncate = floor((toTruncate + 0.0000001) * pow(10,7)) / pow(10, 7);
    return toTruncate;
}

double truncateSeven(double toTruncate)
{
    toTruncate = floor((toTruncate * pow(10, 7))) / pow(10, 7);
}
...
int main()
{
    ...
    double nullPercent = numberNullScore / numberOfSimulations;
    ...
    cout << "0\t";
    printf("%.*f\n", FLT_DIG, truncateSeven(nullPercent));
    cout << holdValue << "\t";
    ...
    cout << holdValue + 5 << "\t";
    printf("%.*f\n", FLT_DIG, truncateSeven(percentHold5));
